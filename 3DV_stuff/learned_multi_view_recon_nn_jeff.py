...
from nemo.neural_motion_model_jeff_v import *
...
parser.add_argument('--droidslam', type=str, default = 'droidslam/custom_vid/',help='Path to DROID-SLAM camera params json file.')
