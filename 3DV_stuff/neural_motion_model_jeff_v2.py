...
class MultiViewModel(nn.Module):
    ...
    def humor_loss(self, pred_dict):
        ...
        for i in range(trans_vel.shape[1]):
            trans = pred_dict['trans'][:,i:i+1]
            root_orient = pred_dict['orient_aa'][:,i:i+1]
            body_pose = body_pose[:,i:i+1]
            trans_vel_i = trans_vel[:,i:i+1]
            root_orient_vel_i = root_orient_vel[:,i:i+1]
            joints_vel_i = joints_vel[:,i:i+1]

            prior_opt_params = [trans_vel_i, joints_vel_i, root_orient_vel_i]
