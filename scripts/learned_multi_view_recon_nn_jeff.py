...
from nemo.neural_motion_model_jeff_slam import *
...
parser.add_argument("--cam_type", type=str, default='slam')
...
#Humor args end
#DROID-SLAM args start
parser.add_argument('--droidslam', type=str, default = 'droidslam/moving_vid/',help='Path to DROID-SLAM camera params json file.')
...
if __name__ == '__main__':
    ...
    if not args.test:
        ...
        loss_dict, info_dict = multi_view_model._step(view_idx, frame_idx,
                                                     update=False,
