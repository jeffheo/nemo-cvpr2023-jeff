...
from nemo.multi_view_sequence_jeff_hybrid import PennActionMultiViewSequence, MultiViewSequence, DemoMultiViewSequence
...
class MultiViewModel(nn.Module):
    ...
    def __init__(self, args, multi_view_seqs, device):
        ...
        self.rotmat_diff = multi_view_seqs.rotations_diff.unsqueeze(0).float().to(device)
        self.trans_diff = multi_view_seqs.translations_diff.unsqueeze(0).unsqueeze(-1).float().to(device)
        # print("Loaded extrinsic rotmat: ", self.extrinsic_rotmat.shape)
        # print("Loaded extrinsic trans: ", self.extrinsic_trans.shape)
        self.extrinsic_rotmat = None
        self.extrinsic_trans = None
        self.extrinsic_trans_init = None
    ...
    # this learned_camera_projection uses fixed camera
    ...
    def learned_camera_projection(self, input_points3d, view_idx):
        ...
        for cur_view_idx in range(self.num_views):
            ...
            # IF WE USE PERSPECTIVE PROJECTION
            # pred_keypoints_2d = perspective_projection(
            #     points3d[cur_view_idx],
            ...
            # IF WE USE SLAHMR'S REPROJECTION INSTEAD
            ...
            pred_keypoints_2d = pred_keypoints_2d.squeeze(0) # get rid of squeeze(0) when using perspective_projection
            output_2d_dict[cur_view_idx] = pred_keypoints_2d
...
class NemoV2KnownCam(NemoV2):
    ...
    # THIS IS FOR CAMERA PARAMS THAT DONT HAVE THE TIME DIMENSION
    ...
    def learned_camera_projection(self, input_points3d, view_idx):
        ...
        for cur_view_idx in range(self.num_views):
            ...
            # if we want to use perspective_projection instead of my_project_point
            ...
            camera_center[0, 0] = self.IMG_D0[cur_view_idx] // 2
            camera_center[0, 1] = self.IMG_D1[cur_view_idx] // 2
            pred_keypoints_2d = self.my_project_point(points2project,
                                                      camera_rotation,
                                                      camera_translation,
                                                      intrinsic_mat)
            output_2d_dict[cur_view_idx] = pred_keypoints_2d
...
class NemoV3(NemoV2KnownCam):
    ...
    # "fake" step method for the init stage that uses the old version of learned_camera_projection
